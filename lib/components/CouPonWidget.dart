                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                // SizedBox(height: 8),
                                Text(data.discountType == CHARGE_TYPE_FIXED ? '${language.get} ${data.discount}' : '${language.get} ${data.discount} % ${language.off}', style: primaryTextStyle(weight: FontWeight.w500)),
                                if (data.description != null) SizedBox(height: 8),
                                if (data.description != null) Text(data.description.validate(), style: secondaryTextStyle(), overflow: TextOverflow.visible,),
                              ],
                            ),
                          ),
                        );
