...
class RideDetailScreenState extends State<RideDetailScreen> {
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //         setState(() {});
                    //       },
                    //       child: scheduleOptionWidget(context, true, 'images/ic_credit_card.png',  language.cash),
                    //     ),
                    //     SizedBox(width: 8,),
                    //     Expanded(
                    //       child: inkWellWidget(
                    ...
                    //           setState(() {});
                    //         },
                    //         child: scheduleOptionWidget(context, true, 'images/ic_credit_card.png',  language.addMoney,extraTitle:"+1500${appStore.currencyCode} more is required to settle your ride payment"),
                    //       ),
                    //     ),
                    //   ],
                    // ),
  ...
  Widget priceDetailComponent() {
    return Container(
      ...
      padding: EdgeInsets.all(12),
      child: riderModel!.ride_has_bids==1?Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          riderModel!.subtotal!-riderModel!.surgeCharge!:riderModel!.subtotal!,space: 8),
