...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_braintree_betc/flutter_braintree_betc.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/pdfx/pdfx.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/OneSignalXCFramework/OneSignalLiveActivities/OneSignalLiveActivities.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/paytm/AppInvokeSDK.framework"
